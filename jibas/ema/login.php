  ...
  <tr>
    ...
    <div id="Main" align="center" style="width:511px; height:234px">
        <table id="Table_01" width="510" height="206" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td rowspan="4">
                    <img src="../images/LOGIN_EMA_01.png" width="147" height="206" alt=""></td>
                <td>
                    <img src="../images/LOGIN_EMA_02.png" width="363" height="89" alt=""></td>
            </tr>
            <tr>
                <td background="../images/LOGIN_EMA_03.png" width="363" height="24">
            ...
            <tr>
                <td background="../images/LOGIN_EMA_04.png" width="363" height="18">
                <span style="color:#666666; font-family:Calibri; font-size:11px">Versi <?=$G_VERSION?> - <?=$G_BUILDDATE?></span>
                </td>
            </tr>
            <tr>
                <td>
                    <img src="../images/LOGIN_EMA_05.png" width="363" height="75" alt=""></td>
            </tr>
        </table>
    </div> <!-- Main -->
