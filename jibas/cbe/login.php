    ...
    <tr>
        ...
        <tr>
            ...
            <td style="padding-right:4px"  valign="top">
                <input type="button" value="Login" id="btLogin" name="btLogin" class="BtnPrimary" onclick="btLogin_click()">
            </td>
            <td style="padding-right:4px"  valign="top">
                <a title="Kembali ke Menu Utama" href="../" style="color:#2fcced; font-weight:bold; font-family:Arial; font-size:12px; text-decoration:underline">Menu Utama</a>
            </td>
        </tr>
        <tr>
            <td colspan="4">
