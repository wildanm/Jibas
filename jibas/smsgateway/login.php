  ...
  <tr>
    ...
    <div id="Main" align="center" style="width:511px; height:234px">
        <table id="Table_01" width="510" height="206" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td rowspan="4">
                    <img src="../images/LOGIN_SMS_01.png" width="147" height="206" alt=""></td>
                <td>
                    <img src="../images/LOGIN_SMS_02.png" width="363" height="89" alt=""></td>
            </tr>
            <tr>
                <td background="../images/LOGIN_SMS_03.png" width="363" height="24">
                ...
                <input name="password" class="InputTxt" id="passwords" style="color:#000000; display:none;width:80px; border:1px #666666 solid" value="" onblur="ChgInputPass('passwordsfake','passwords','0')"  type="password"    /></td>
                    ...
                    <td><a title="Kembali ke Menu Utama" href="../index.php" style="color:#0047bd; text-decoration:underline">Menu Utama</a></td>
                  </tr>
                </table>                
                </td>
            </tr>
            <tr>
                <td background="../images/LOGIN_SMS_04.png" width="363" height="18">
                <span style="color:#666666; font-family:Calibri; font-size:11px">Versi <?=G_VERSION?> - <?=G_BUILDDATE?></span>
                </td>
            </tr>
            <tr>
                <td>
                    <img src="../images/LOGIN_SMS_05.png" width="363" height="75" alt=""></td>
            </tr>
        </table>
    </div> <!-- Main -->
