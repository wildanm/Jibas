...
if (isset($_REQUEST['Kirim']))
{
    ...
    CreateSMSTunggakan($jenis, $departemen, $nis, $sms, $success);

    if ($success)
    {
        CommitTrans();
        CloseDb();
        $msg = "SMS Tunggakan telah disiapkan";
    }
    else
    {
        RollbackTrans();
    ...
    <tr height="150">
        ...
        <td align="center" style="background-color:#FFFFFF">
            ...
            <form name="main" method="post" onSubmit="return validasi();">
                ...
                <textarea rows="5" id="sms" name="sms" cols="45"><?=$sms?></textarea><br>
                <input type="submit" id="Kirim" name="Kirim" value="Kirim SMS" class="but">
            </form>
            <!-- END OF CONTENT //--->
        </td>
