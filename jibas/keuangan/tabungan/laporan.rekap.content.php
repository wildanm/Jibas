...
function ShowDetail(departemen, idtabungan, tanggal1, tanggal2, petugas, jenis)
{
	var addr = "laporan.rekap.detail.php?departemen="+departemen+"&idtabungan="+idtabungan+"&tanggal1="+tanggal1+"&tanggal2="+tanggal2+"&petugas="+petugas+"&jenis="+jenis;
