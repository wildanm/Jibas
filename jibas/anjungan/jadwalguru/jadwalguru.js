jg_ChangeDept = function() {
    ...
    $.ajax({
        url : 'jadwalguru/jadwalguru.select.php?dept='+dept,
        type: 'get',
...
jg_ChangeJadwal = function() {
    ...
    $.ajax({
        url : 'jadwalguru/jadwalguru.select.php?dept='+dept+'&jadwal='+jadwal,
        type: 'get',
        success : function(html) {
            $('#jg_content').html('');
            $('#jg_selection').html(html);
...
jg_ShowContent = function() {
    ...
    $.ajax({
        url : 'jadwalguru/jadwalguru.content.php?departemen='+dept+'&info='+jadwal+'&nip='+guru+'&tahunajaran='+tahunajaran,
        type: 'get',
        success : function(html) {
