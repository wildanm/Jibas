...
<tr>
    ...
    <td width="*" align="left" bgcolor="#DBD8F3">
<?      ShowYearCombo('psb_thnlahirayah', 'psb_changeTahunLahirAyah()', 1950, date('Y') + 1, date('Y')); ?>&nbsp;
...
<?      ShowDateCombo('psb_tgllahirayah', 'psb_changeTanggalLahirAyah()', date('Y'), date('n'), date('j')); ?>
    ...
    <td width="*" align="left" bgcolor="#E9AFCF">
<?      ShowYearCombo('psb_thnlahiribu', 'psb_changeTahunLahirIbu()', 1950, date('Y') + 1, date('Y')); ?>&nbsp;
