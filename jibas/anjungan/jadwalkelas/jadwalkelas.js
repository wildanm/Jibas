jk_ChangeDept = function() {
    ...
    $.ajax({
        url : 'jadwalkelas/jadwalkelas.select.php?dept='+dept,
        type: 'get',
...
jk_ChangeTingkat = function() {
    ...
    $.ajax({
        url : 'jadwalkelas/jadwalkelas.select.php?dept='+dept+'&tingkat='+tingkat,
        type: 'get',
        success : function(html) {
            $('#jk_content').html('');
            $('#jk_selection').html(html);
...
jk_ShowContent = function() {
    ...
    $.ajax({
        url : 'jadwalkelas/jadwalkelas.content.php?departemen='+dept+'&kelas='+kelas+'&info='+jadwal,
        type: 'get',
        success : function(html) {
