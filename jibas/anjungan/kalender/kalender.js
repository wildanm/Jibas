ka_ChangeDept = function() {
    ...
    $.ajax({
        url : 'kalender/kalender.select.php?dept='+dept,
        type: 'get',
...
ka_ShowContent = function() {
    ...
    $.ajax({
        url : 'kalender/kalender.content.php?kalender='+kalender,
        type: 'get',
        success : function(html) {
...
ka_GoToNextMonth = function () {	
   ...
   $.ajax({
        url : "kalender/kalender.content.php?kalender="+kalender+"&bln="+bln+"&thn="+thn+"&next=1&prevbln="+prevbln+"&prevthn="+prevthn+"&last="+last,
        type: 'get',
        success : function(html) {
            $('#ka_content').html(html);
        }
...
ka_GoToPrevMonth = function () {	
   ...
   $.ajax({
        url : "kalender/kalender.content.php?kalender="+kalender+"&bln="+bln+"&thn="+thn+"&next="+next+"&last="+last,
        type: 'get',
        success : function(html) {
            $('#ka_content').html(html);
        }
