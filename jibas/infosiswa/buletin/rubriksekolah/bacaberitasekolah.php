...
<table id="Table_01" width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
	  ...
	  <td background="../../images_slice/BGNews_05.png" align="left"><div align="left" style="padding-bottom:10px"><span style="color:#339900; font-size:20px; font-weight:bold">.:</span><span style="color:#FF6600; font-family:Calibri; font-size:16px; font-weight:bold; ">Berita Sekolah</span></div></td>
