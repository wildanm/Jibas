...
OpenDb();
$sql="INSERT INTO jbsvcr.pesan SET tanggalpesan='".$tanggalpesan." ".$jampesan."', tanggaltampil='$tanggalpesan',judul='$judul',pesan='$pesan',idguru=NULL,nis='$idguru',ke$_REQUEST[kesiapa]=1";
//echo $sql; exit;
$result=QueryDb($sql);
CloseDb();
