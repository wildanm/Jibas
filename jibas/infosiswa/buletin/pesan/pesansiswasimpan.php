...
OpenDb();
$sql="INSERT INTO jbsvcr.pesan SET tanggalpesan='".$tanggalpesan." ".$jampesan."', tanggaltampil='$tanggaltampil',judul='$judul',pesan='$pesan',idguru=NULL,nis='$idpengirim',kesiswa=1";
$result=QueryDb($sql);
CloseDb();
