...
?>
<? OpenDb();
		$sql="SELECT idguru FROM jbsvcr.fileshareguru GROUP BY idguru";
		$result=QueryDb($sql);
...
<!--
		...
		The numbers must match for the menu to work, multiple menus may be used on a single page by
             ...
             4: When adding a child sub menu, the new UL and LI tags must be including within a parent <LI> tag,
                but not within the parents <a> tag.  Note that in the sample menu below, the closing </LI> tag
