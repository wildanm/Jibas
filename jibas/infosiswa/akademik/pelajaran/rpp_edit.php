...
<!-- TABLE CONTENT -->
<tr height="25">
<td class="header" colspan="2" align="center">Ubah Rencana Program Pengajaran</td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="materi" id="materi" size="83" maxlength="225" value="<?=$materi?>" onFocus="showhint('Kode pembelajaran tidak boleh lebih dari 20 karakter!', this, event, '120px')"  onKeyPress="return focusNext('deskripsi', event)"/>
