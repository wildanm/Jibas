...
<td align="left" valign="top">
	...
	<tr height="25">
        ...
        <?	if (SI_USER_LEVEL() != $SI_USER_STAFF) {  ?>
        <td align="center" > 
			<a href="#" onClick="newWindow('ubah_jam.php?replid=<?=$row_jam[0] ?>','Ubah Jam Belajar','350','275','resizable=0,scrollbars=0,status=0,toolbar=0')" onMouseOver="showhint('Ubah Jam Belajar!', this, event, '75px')">        
