                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td align="right"><?
						...
						?>
						Page : 
						<input <?=$disback?> type="button" class="but" title="Sebelumnya" name="back" value="<" onClick="change_page('<?=(int)$page-1?>','<?=$replid?>')" onMouseOver="showhint('Sebelumnya', this, event, '75px')">
						<?=$page+1?>
						<input <?=$disnext?> type="button" class="but" name="next" title="Selanjutnya" value=">" onClick="change_page('<?=(int)$page+1?>','<?=$replid?>')" onMouseOver="showhint('Berikutnya', this, event, '75px')">
						<? } ?>					</td>
                  </tr>
                </table>            </td>
			<td width="20">&nbsp;</td>
