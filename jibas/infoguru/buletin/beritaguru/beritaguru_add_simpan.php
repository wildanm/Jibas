...
if ($sender=="tambah"){
$updir = $UPLOAD_DIR."lampiranbg".GetOSSlash();
OpenDb();
$dir_bln=date(m);
$dir_thn=date(Y);
...
$isi=$_REQUEST['isi'];
$idguru=SI_USER_ID();
$sql1="INSERT INTO jbsvcr.beritaguru SET judul='$judul', tanggal='".$tanggal." ".$jam."', abstrak='$abstrak', isi='$isi', idguru='$idguru'";
...
if ($file1!=""){
	...
	$namafile1=str_replace(" ","",$x1[0]);
		...
		$sql3="INSERT INTO jbsvcr.lampiranberitaguru SET idberita='$lastid', namafile='".$namafile1."-".$lastid.$ext1."', direktori='".$new_dir_db."'";
...
if ($file2!=""){
	...
	$namafile2=str_replace(" ","",$x2[0]);
		...
		$sql4="INSERT INTO jbsvcr.lampiranberitaguru SET idberita='$lastid', namafile='".$namafile2."-".$lastid.$ext2."', direktori='".$new_dir_db."'";
...
if ($file3!=""){
	...
	$namafile3=str_replace(" ","",$x3[0]);
		...
		$sql5="INSERT INTO jbsvcr.lampiranberitaguru SET idberita='$lastid', namafile='".$namafile3."-".$lastid.$ext3."', direktori='".$new_dir_db."'";
...
<?
	...
	if ($file1!=""){
		if ($repd1!=""){
			...
			<?
			$sql="SELECT direktori,namafile FROM jbsvcr.lampiranberitaguru WHERE replid=".$repd1;
			echo $sql."<br>";
			$result=QueryDb($sql);
			...
			<?
			$sql="DELETE FROM jbsvcr.lampiranberitaguru WHERE replid=".$repd1;
			echo $sql."<br>";
			$result=QueryDb($sql);
			CloseDb();
		}
	...
	$namafile1=str_replace(" ","",$x1[0]);
		...
		$sql="INSERT INTO jbsvcr.lampiranberitaguru SET idberita='$replid', namafile='".$namafile1."-".$replid.$ext1."', direktori='".$new_dir_db."'";
		$result=QueryDb($sql);
		CloseDb();
	} else {
		if ($d1!="0"){
...
if ($file2!=""){
		if ($repd2!=""){
			...
			<?
			$sql="SELECT direktori,namafile FROM jbsvcr.lampiranberitaguru WHERE replid=".$repd2;
			echo $sql."<br>";
			$result=QueryDb($sql);
			$row=@mysql_fetch_array($result);
				//Hapus filenyah..............
			...
			<?
			$sql="DELETE FROM jbsvcr.lampiranberitaguru WHERE replid=".$repd2;
			echo $sql."<br>";
			$result=QueryDb($sql);
			CloseDb();
		}
	...
	$namafile2=str_replace(" ","",$x2[0]);
		...
		$sql="INSERT INTO jbsvcr.lampiranberitaguru SET idberita='$replid', namafile='".$namafile2."-".$replid.$ext2."', direktori='".$new_dir_db."'";
		$result=QueryDb($sql);
		CloseDb();
	} else {
		if ($d2!="0"){
...
if ($file3!=""){
		if ($repd3!=""){
			...
			<?
			$sql="SELECT direktori,namafile FROM jbsvcr.lampiranberitaguru WHERE replid=".$repd3;
			echo $sql."<br>";
			$result=QueryDb($sql);
			$row=@mysql_fetch_array($result);
				//Hapus filenyah..............
			...
			<?
			$sql="DELETE FROM jbsvcr.lampiranberitaguru WHERE replid=".$repd3;
			echo $sql."<br>";
			$result=QueryDb($sql);
			CloseDb();
		}
	...
	$namafile3=str_replace(" ","",$x3[0]);
		...
		$sql="INSERT INTO jbsvcr.lampiranberitaguru SET idberita='$replid', namafile='".$namafile3."-".$replid.$ext3."', direktori='".$new_dir_db."'";
		$result=QueryDb($sql);
		CloseDb();
	} else {
		if ($d3!="0"){
