...
OpenDb();
$sql="SELECT YEAR(b.tanggal) as thn,MONTH(b.tanggal) as bln,DAY(b.tanggal) as tgl,b.replid as replid,b.judul as judul,b.abstrak as abstrak ,b.isi as berita, p.nama as nama FROM jbsvcr.beritaguru b, jbssdm.pegawai p WHERE p.nip=b.idguru AND b.replid=$replid";
$result=QueryDb($sql);
...
<table id="Table_01" width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
	  ...
	  <td width="759" align="left" background="../../images_slice/BGNews_05.png">
	  ...
	  <td width="425" align="right" valign="top" background="../../images_slice/BGNews_05.png"><img src="../../images/ico/closelabel_transp.gif" width="19" height="22" style="cursor:pointer" onclick="window.close();" /></td>
