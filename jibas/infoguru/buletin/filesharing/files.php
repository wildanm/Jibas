...
if ($file[$x]!=""){
		...
		$phisycaldir = str_replace("root\\",$UPLOAD_DIR."fileshare\\",$phisycaldir);
		//echo $phisycaldir;
...
//$dfullpath = str_replace("root/", $WEB_UPLOAD_DIR."fileshare/", $dfullpath);
//echo $fullpath;
?>
...
<tr height="25">
	...
	<? } ?>
    <td align="left"><a title="<?=$WEB_UPLOAD_DIR?>fileshare/<?=$fullpath?><?=$row[filename]?>" href="<?=$WEB_UPLOAD_DIR?>fileshare/<?=$fullpath?><?=$row[filename]?>" target="_blank"><?=$row['filename'] ?></a></td>
