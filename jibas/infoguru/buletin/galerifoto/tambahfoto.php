...
function chg(y){
	...
	//alert (x);
	//var filenum = "file"+y;
	//var ft=document.foto.filenum.value;
	//w=x.charAt(i);
	//alert ('Kar'+x);
	var y;
	if (x.length>0){
...
<table width="100%" border="0" cellspacing="0" >
  ...
  <tr id="tr<?=$i?>">
    ...
    <th align="center" scope="row"><input type="text" id="keterangan<?=$i?>" name="keterangan<?=$i?>" style="visibility:hidden; " />
      <input type="hidden" id="ext<?=$i?>" name="ext<?=$i?>"/></th>
  </tr>
  <? 	} ?>
  <tr>
  ...
  <tr>
    <th colspan="3" align="center" scope="row"><span class="style1">Maaf, jumlah gambar yang Anda miliki sudah melebihi batas Quota !</span><br>
	  <span class="style5">Silakan hapus beberapa gambar terlebih dahulu !</span></th>
  </tr>
  <? } ?>
  <tr>
