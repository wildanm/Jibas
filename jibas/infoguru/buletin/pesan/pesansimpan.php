...
$updir = $UPLOAD_DIR."pesan".GetOSSlash();
$dir_bln=date(m);
$dir_thn=date(Y);
...
OpenDb();
$sql="INSERT INTO jbsvcr.pesan SET tanggalpesan='".$tanggalpesan." ".$jampesan."', tanggaltampil='$tanggalpesan',judul='$judul',pesan='$pesan',idguru='$idguru',nis=NULL,keguru=1";
$result=QueryDb($sql);
CloseDb();
